...
export const Simulador = () => {
    ...
    const calculateLoan = () => {
        ...
        if (parsedAmount && parsedInterestRate && parsedTerm) {
            const monthlyInterest = parsedInterestRate / 100 / 12;
            const numberOfPayments = parsedTerm;
            const calculatedMonthlyPayment = (parsedAmount * monthlyInterest) / 
                ...
                <div className="loan-simulator">
                    ...
                    <form id="simulator-form" onSubmit={(e) => e.preventDefault()}>
                        <div className="form-group">
                            ...
                            <input type="text" id="loan-type" name="loan-type" value={loanType} readOnly />
                        </div>
                        <div className="form-group">
                        ...
                        <div className="form-group">
                            ...
                            <input type="number" id="interest-rate" name="interest-rate" value={interestRate} readOnly />
                        </div>
                        <div className="form-group">
